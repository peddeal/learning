import { ref, shallowRef, inject, watchEffect, watch, computed, createVNode, mergeProps, createElementVNode, Fragment, Teleport, withDirectives, vShow, onScopeDispose, toRef, reactive, provide, toValue, toRaw, readonly, nextTick, Transition } from 'vue';
import { r as usePosition, s as useVariant, e as useRounded, t as genOverlays, l as VProgressLinear, c as VDefaultsProvider, f as useBackgroundColor, v as useRouter, M as MaybeTransition, w as makeVariantProps, m as makeRoundedProps, x as makePositionProps, y as makeLocationProps, j as makeTransitionProps, z as parseAnchor, A as flipSide, B as flipAlign, C as flipCorner, D as getAxis } from './VCol-C8It2Y1_.mjs';
import { g as genericComponent, p as propsFactory, f as useProxiedModel, o as provideTheme, V as VuetifyLayoutKey, x as useToggleScope, P as useLayout, Q as refElement, h as useRender, v as getCurrentInstance, q as useRtl, y as useDimension, t as convertToUnit, R as omit, i as makeThemeProps, A as makeDimensionProps, m as makeComponentProps, N as templateRef, O as matchesSelector, H as destructComputed, J as CircularBuffer, K as deepEqual, L as consoleError, C as clamp, M as defer, s as standardEasing } from './server.mjs';
...
export { VSnackbar as V, VOverlay as a, animate as b, useLazy as c, makeLazyProps as d, forwardRefs as f, getTargetBox as g, makeVOverlayProps as m, nullifyTransforms as n, useScopeId as u };
//# sourceMappingURL=VSnackbar-D91Swnw_.mjs.map
