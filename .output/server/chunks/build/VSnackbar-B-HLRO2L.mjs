import { ref, watch, nextTick, mergeProps, createVNode, shallowRef, inject, watchEffect, computed, createElementVNode, Fragment, Teleport, withDirectives, vShow, onScopeDispose, Transition, toRef, reactive, provide, toValue, toRaw, readonly } from 'vue';
import { g as genericComponent, p as propsFactory, j as useProxiedModel, d as useRender, k as provideTheme, V as VuetifyLayoutKey, t as useToggleScope, P as useLayout, Q as refElement, q as getCurrentInstance, l as useRtl, v as useDimension, o as convertToUnit, R as omit, e as makeThemeProps, y as makeDimensionProps, m as makeComponentProps, N as templateRef, F as acceleratedEasing, s as standardEasing, G as deceleratedEasing, O as matchesSelector, H as destructComputed, J as CircularBuffer, K as deepEqual, L as consoleError, A as clamp, M as defer } from './server.mjs';
import { g as VDefaultsProvider, r as usePosition, s as useVariant, d as useRounded, t as genOverlays, l as VProgressLinear, e as useBackgroundColor, v as useRouter, M as MaybeTransition, w as makeVariantProps, m as makeRoundedProps, x as makePositionProps, y as makeLocationProps, j as makeTransitionProps, z as parseAnchor, A as flipSide, B as flipAlign, C as flipCorner, D as getAxis } from './VCol-DYd6kilI.mjs';
...
export { VDialog as V, VSnackbar as a, animate as b, forwardRefs as f, makeLazyProps as m, nullifyTransforms as n, useLazy as u };
//# sourceMappingURL=VSnackbar-B-HLRO2L.mjs.map
