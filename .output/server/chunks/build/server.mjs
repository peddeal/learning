import { defineComponent as defineComponent$1, shallowRef, toRef, readonly, reactive, watchEffect, warn, inject as inject$1, ref, computed, unref, provide, useId, h, Suspense, toValue, Fragment, capitalize, toRaw, getCurrentInstance as getCurrentInstance$1, watch, onScopeDispose, hasInjectionContext, shallowReactive, createVNode, mergeProps, createElementVNode, effectScope, createElementBlock, cloneVNode, normalizeClass, defineAsyncComponent, normalizeStyle, useSSRContext, createApp, withCtx, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, isReadonly, isRef, isShallow, isReactive, nextTick, getCurrentScope, toRefs } from 'vue';
...
const _routes = [
  {
    name: "cart",
    path: "/cart",
    component: () => import('./cart-CYVzsxgf.mjs')
  },
  {
    name: "about",
    path: "/about",
    component: () => import('./about-CmjobXEq.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-_wSlDz4l.mjs')
  },
  {
    name: "review",
    path: "/review",
    component: () => import('./review-XaCCh6hb.mjs')
  },
  {
    name: "Payment",
    path: "/Payment",
    component: () => import('./Payment-DceaZLVt.mjs')
  }
];
...
const vuetify_WIue46TOniyjkogbUIE0Q_xwWw7mT5k7_LeS4ZtT8SM = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-D07xnW44.mjs').then((m) => m.default || m))
};
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VMain, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_NuxtLayout, null, null, _parent3, _scopeId2));
                } else {
                  return [
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-yUiM9uWN.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DUMX2p1C.mjs'));
...
export { VApp as $, clamp as A, keys as B, makeTagProps as C, useSsrBoot as D, EventProp as E, acceleratedEasing as F, deceleratedEasing as G, destructComputed as H, IconValue as I, CircularBuffer as J, deepEqual as K, consoleError as L, defer as M, templateRef as N, matchesSelector as O, useLayout as P, refElement as Q, omit as R, createRange as S, provideDefaults as T, breakpoints as U, VuetifyLayoutKey as V, useLayoutItem as W, makeLayoutItemProps as X, useTheme as Y, pickWithRest as Z, useResizeObserver as _, useNuxtApp as a, VMain as a0, __nuxt_component_0 as a1, includes as a2, isCssColor as a3, isParsableColor as a4, parseColor as a5, getForeground as a6, consoleWarn as a7, findChildrenWithProvide as a8, useIcon as a9, flattenFragments as aa, hasEvent as ab, isObject as ac, onlyDefinedProps as ad, useRuntimeConfig as b, nuxtLinkDefaults as c, useRender as d, entry$1 as default, makeThemeProps as e, useLocale as f, genericComponent as g, callEvent as h, getCurrentInstanceName as i, useProxiedModel as j, provideTheme as k, useRtl as l, makeComponentProps as m, navigateTo as n, convertToUnit as o, propsFactory as p, getCurrentInstance as q, resolveRouteObject as r, standardEasing as s, useToggleScope as t, useRouter as u, useDimension as v, wrapInArray as w, pick as x, makeDimensionProps as y, filterInputAttrs as z };
